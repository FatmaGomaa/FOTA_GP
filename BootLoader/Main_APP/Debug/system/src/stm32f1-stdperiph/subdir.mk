...
system/src/stm32f1-stdperiph/%.o: ../system/src/stm32f1-stdperiph/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -DDEBUG -DUSE_FULL_ASSERT -DTRACE -DOS_USE_TRACE_SEMIHOSTING_DEBUG -DSTM32F10X_MD -DUSE_STDPERIPH_DRIVER -DHSE_VALUE=8000000 -I"../include" -I"D:\iti\Tourkey\ARM_WorkSpace\FOTA_GP\BootLoader\Main_APP\src\GPIO" -I"D:\iti\Tourkey\ARM_WorkSpace\FOTA_GP\BootLoader\Main_APP\src\LIB" -I"D:\iti\Tourkey\ARM_WorkSpace\FOTA_GP\BootLoader\Main_APP\src\RCC" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f1-stdperiph" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
