...
/* Data Frame Size */
#define DATA_FRAME_SIZE            200
#define DATA_FRAME_BITS_SIZE       8
/*========================================================================================================================================*/
/*                                                                  Definitions                                                           */
/*========================================================================================================================================*/
 ...
 /* Check if a new program has been uploaded */
  if (FlashNewApp_Flag == true)
  {
      ...
      else if(SendRQT == true && ResponseRQT == false)
      {
          ...
          /*============== Parsing Option 1 ==============*/
          for (int index = 0 ; index < DATA_FRAME_SIZE ; index++)
          {
          ...
          /*============== Parsing Option 2 ==============*/
          for (int index = 0 ; index < (DATA_FRAME_SIZE * DATA_FRAME_BITS_SIZE) ; index++)
          {
